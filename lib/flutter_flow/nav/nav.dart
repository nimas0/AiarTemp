      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => SplashScreenWidget(
            messages: params.getParam('messages', ParamType.JSON),
          ),
        ),
        FFRoute(
          name: 'Register',
        ...
        FFRoute(
          ...
          path: '/profile6',
          requireAuth: true,
          builder: (context, params) => Profile6Widget(),
        ),
        FFRoute(
          name: 'Notifications',
          path: '/notifications',
        ...
        FFRoute(
          ...
          path: '/OnboardingChat',
          requireAuth: true,
          builder: (context, params) => OnboardingChatWidget(),
        )
